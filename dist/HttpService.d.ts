import { IServiceParams, IGetServiceParams, ISaveServiceParams } from "./IUtilityTypes";
/** 网络请求服务 */
export default class HttpService {
    ...
    /** 执行控制器 */
    private static _executeController;
    static executeController<T>(host: string, params: ISaveServiceParams): Promise<T | undefined>;
}
